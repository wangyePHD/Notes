...
| PointMAE  | 200  | 94.9% $\pm$ 2.43 | --- |
| PointMAE  | 300  | 95.1% $\pm$ 2.26 | --- |
| 2fold-PointMAE  | 50  |93.2% $\pm$ 3.79 | 92.34% |
| 2fold-PointMAE  | 100  | 95.3% $\pm$ 2.65 | 92.50% |

从上表前四行表明，在小数据集（1/10 shapenet）下预训练PointMAE 100epoch达到最佳。继续训练200epoch或者300epoch，都无法实现效果的提升。说明在当前的数据量下，100 epoch进行预训练已经enough。后续的实验可考虑100 epoch的设置。
...
| PointMAE  | 50  | 92.3% $\pm$ 2.83 | 92.54% |
| 2fold-PointMAE  | 50  |93.2% $\pm$ 3.79 | 92.34% |
| 2fold Random mask  | 50   | 92.2% $\pm$ 4.17 | --- |
| PointMAE           |  100 | 95.2% $\pm$ 2.52 | 92.54% |
| 2fold-PointMAE     | 100  | 95.3% $\pm$ 2.65 | 92.50% |
| 2fold Random mask  | 100  | 94.6% $\pm$ 2.58 | --- |
